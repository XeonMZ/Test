...
const jsonLd = {
  ...
  areaServed: ['Sumenep', 'Surabaya', 'Sidoarjo', 'Pasuruan', 'Malang', 'Mojokerto', 'Jombang'].map((c) => ({ '@type': 'City', name: c })),
  makesOffer: ['Travel Reguler', 'Tour & Wisata', 'Carter Kendaraan', 'Jasa Titip & Pengiriman Paket'].map((n) => ({ '@type': 'Offer', itemOffered: { '@type': 'Service', name: n } })),
  priceRange: 'Rp',
};
