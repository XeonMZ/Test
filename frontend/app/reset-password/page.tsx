...
function ResetPasswordForm() {
  ...
  if (!token) {
    return (
      <>
        <p role="alert" className="mt-6 rounded-md bg-rose-50 px-4 py-3 text-center text-sm font-semibold text-rose-700 dark:bg-rose-950/40 dark:text-rose-300">
          Link reset tidak valid atau tidak lengkap. Minta link baru dari halaman lupa password.
        </p>
        <p className="mt-6 text-center text-sm text-slate-500 dark:text-slate-400">
          <Link href="/forgot-password" className="font-semibold text-primary hover:underline">Kirim ulang link reset</Link>
        </p>
      </>
    );
  }
