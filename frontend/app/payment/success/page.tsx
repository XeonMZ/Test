  ...
  return (
    <main className="grid min-h-screen place-items-center bg-emerald-50 px-4 dark:bg-slate-950">
      <section className="w-full max-w-xl rounded-[2rem] border border-emerald-100 bg-white p-10 text-center shadow-sm dark:border-emerald-900/50 dark:bg-slate-900">
        ...
        <h1 className="mt-5 font-display text-3xl font-extrabold text-slate-950 dark:text-white">Pembayaran Berhasil</h1>
        ...
        <div className="mt-8 flex flex-col justify-center gap-3 sm:flex-row">
          <Link href="/customer/tickets" className="inline-flex min-h-11 items-center justify-center gap-2 rounded-2xl bg-primary px-6 text-sm font-extrabold text-white shadow-sm shadow-primary/20 transition hover:bg-primary/90">
