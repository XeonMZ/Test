              ...
              actions={
                active ? (
                  !b.picked_up_at ? (
                    ...
                    <button onClick={() => dropoffMutation.mutate(b.id)} disabled={dropoffMutation.isPending} className="inline-flex min-h-10 items-center gap-1.5 rounded-md bg-primary px-3 text-xs font-extrabold text-white hover:bg-primary/90 disabled:opacity-60">
              ...
              actions={
                active ? (
                  j.status !== 'picked_up' && !j.picked_up_at ? (
                    ...
                    <button onClick={() => jastipMutation.mutate({ id: j.id, status: 'delivered' })} disabled={jastipMutation.isPending} className="inline-flex min-h-10 items-center gap-1.5 rounded-md bg-primary px-3 text-xs font-extrabold text-white hover:bg-primary/90 disabled:opacity-60">
