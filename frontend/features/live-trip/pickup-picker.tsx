...
export function PickupPicker({ title, value, onChange, accent }: { title: string; value: PickedLocation; onChange: (v: PickedLocation) => void; accent: 'pickup' | 'drop' }) {
  ...
  const fieldInput = 'min-h-11 w-full rounded-md border border-slate-200 bg-white px-4 text-sm font-semibold text-slate-900 shadow-sm outline-none transition focus:border-primary focus:ring-2 focus:ring-primary/20 dark:border-slate-800 dark:bg-slate-950 dark:text-slate-100';
