...
export function JastipPage() {
  ...
  const [form, setForm] = useState({
    item_name: '', description: '', sender_name: '', receiver_name: '', driver_id: '',
  ...
  const createMutation = useMutation({
    ...
    onSuccess: () => {
      ...
      setOpen(false);
      setForm({ item_name: '', description: '', sender_name: '', receiver_name: '', driver_id: '', pickup_label: '', pickup_lat: '', pickup_lng: '', drop_label: '', drop_lat: '', drop_lng: '', fee: '' });
