        ...
        <div className="grid grid-cols-3 gap-2 sm:grid-cols-4">
          {value.map((path, i) => (
            ...
            >
              ...
              {i === 0 ? <span className="absolute left-1 top-1 flex items-center gap-0.5 rounded-md bg-primary px-1.5 py-0.5 text-[9px] font-semibold uppercase tracking-button text-white"><Star size={9} /> Utama</span> : null}
