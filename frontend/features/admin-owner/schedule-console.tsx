              ...
              <AppCard key={schedule.id} className="overflow-hidden !p-0">
                ...
                >
                  ...
                  <div className="flex shrink-0 items-center gap-3 sm:w-40 sm:flex-col sm:items-start sm:gap-1">
                    <p className="flex items-center gap-1.5 font-display text-2xl font-extrabold text-slate-950 dark:text-white"><Clock3 size={18} className="text-primary" /> {formatTime(schedule.departure_at)}</p>
              ...
              {editId === booking.id ? (
                <tr>
                  <td colSpan={8} className="bg-primary/5 px-4 py-4">
                    ...
                    >
                      <p className="text-xs font-extrabold uppercase tracking-wide text-slate-500">Edit nama penumpang</p>
                      ...
                      <div className="flex gap-2">
                        <button type="submit" disabled={editMutation.isPending} className="inline-flex min-h-10 items-center gap-1.5 rounded-xl bg-primary px-4 text-xs font-extrabold text-white hover:bg-primary/90 disabled:opacity-60">
      ...
      renderStats={(s) => (
        <>
          ...
          <span className="text-center">
            ...
            <span className="block text-[10px] font-bold uppercase tracking-wide text-slate-400">Pendapatan</span>
          </span>
        </>
      )}
