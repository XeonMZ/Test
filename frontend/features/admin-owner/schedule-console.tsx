                ...
                <tr>
                  <td colSpan={8} className="bg-primary/5 px-4 py-4">
                    ...
                    >
                      ...
                      <div className="flex gap-2">
                        <button type="submit" disabled={editMutation.isPending} className="inline-flex min-h-10 items-center gap-1.5 rounded-md bg-primary px-4 text-xs font-extrabold text-white hover:bg-primary/90 disabled:opacity-60">
