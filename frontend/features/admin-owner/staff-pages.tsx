                  ...
                  <td className="py-3 text-right">
                    {resetTarget === a.id ? (
                      ...
                      >
                        ...
                        <button type="submit" disabled={resetMutation.isPending} className="inline-flex min-h-9 items-center gap-1.5 rounded-xl bg-primary px-3 text-xs font-extrabold text-white transition hover:bg-primary/90 disabled:opacity-60">
