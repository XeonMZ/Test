      ...
      {query.isLoading ? <Skeleton className="h-48" /> : (query.data?.data.length ?? 0) === 0 ? (
        ...
        <AppCard className="overflow-x-auto">
          <table className="min-w-full text-left text-sm">
            <thead className="text-xs uppercase tracking-wide text-slate-500"><tr><th className={th}>Kode</th><th className={th}>Merek</th><th className={th}>Plat</th><th className={th}>Kursi</th><th className={th}>Status</th><th className="py-3 text-right font-extrabold">Ubah status</th></tr></thead>
                  ...
                  <td className="py-3 text-right">
                    {resetTarget === a.id ? (
                      ...
                      >
                        ...
                        <button type="submit" disabled={resetMutation.isPending} className="inline-flex min-h-9 items-center gap-1.5 rounded-md bg-primary px-3 text-xs font-extrabold text-white transition hover:bg-primary/90 disabled:opacity-60">
  ...
  return (
    <div className="space-y-6">
      ...
      {query.isLoading ? <Skeleton className="h-40" /> : (query.data?.data.length ?? 0) === 0 ? (
        ...
        <AppCard className="overflow-x-auto">
          <table className="min-w-full text-left text-sm">
            <thead className="text-xs uppercase tracking-wide text-slate-500"><tr><th className={th}>Nama</th><th className={th}>Email</th><th className={th}>No. SIM</th><th className={th}>Status</th><th className="py-3 text-right font-extrabold">Ubah status</th></tr></thead>
            <tbody className="divide-y divide-slate-100 dark:divide-slate-800">
