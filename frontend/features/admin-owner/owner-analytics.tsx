          ...
          <div className="flex items-center gap-2">
            {PERIODS.map((p) => (
              <button
                ...
                className={`min-h-10 rounded-md px-4 text-sm font-semibold uppercase tracking-button transition ${period === p.key ? 'bg-primary text-white' : 'border border-slate-200 text-slate-600 hover:border-primary hover:text-primary dark:border-slate-800 dark:text-slate-300'}`}
              >
                {p.label}
              </button>
            ))}
          ...
          <div className="flex items-center gap-2">
            {[14, 30, 90].map((option) => (
              <button
                ...
                className={`min-h-10 rounded-md px-4 text-sm font-semibold uppercase tracking-button transition ${days === option ? 'bg-primary text-white' : 'border border-slate-200 text-slate-600 hover:border-primary hover:text-primary dark:border-slate-800 dark:text-slate-300'}`}
              >
                {option} hari
              </button>
            ))}
