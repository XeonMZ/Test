        ...
        >
          <label className="relative min-w-0 flex-1">
            ...
            <input
              ...
              placeholder="Cari…"
              className="min-h-11 w-full rounded-md border border-slate-200 bg-white pl-10 pr-4 text-sm font-semibold shadow-sm outline-none transition focus:border-primary dark:border-slate-800 dark:bg-slate-950"
            />
          </label>
      ...
      {query.isLoading ? (
        ...
        <AppCard className="overflow-x-auto">
          <table className="min-w-full text-left text-sm">
            <thead className="text-xs uppercase tracking-button text-slate-500">{header}</thead>
    ...
    <AppCard>
      ...
      {query.isLoading ? (
        ...
        <div className="mt-4 overflow-x-auto">
          <table className="min-w-full text-left text-sm">
            <thead className="text-xs uppercase tracking-button text-slate-500"><tr><th className={th}>Judul</th><th className={th}>Target</th><th className={th}>Pengirim</th><th className={th}>Terkirim</th><th className={th}>Dibaca</th><th className={th}>Status</th><th className={th}>Waktu kirim</th></tr></thead>
    ...
    <div className="space-y-6">
      <AppCard>
        ...
        >
          ...
          <button type="submit" disabled={broadcastMutation.isPending} className="inline-flex min-h-11 items-center justify-center gap-2 rounded-md bg-primary px-5 text-sm font-semibold uppercase tracking-button text-white transition hover:bg-primary-deep disabled:opacity-60 sm:col-span-2">
              ...
              <li key={setting.key} className="flex flex-wrap items-center gap-3 py-4">
                ...
                {editing === setting.key ? (
                  <span className="flex gap-2">
                    <button onClick={() => save(setting.key)} disabled={saveMutation.isPending} className="inline-flex min-h-9 items-center gap-1.5 rounded-md bg-primary px-3 text-xs font-semibold uppercase tracking-button text-white transition hover:bg-primary-deep disabled:opacity-60">
