  ...
  return (
    <div className="space-y-6">
      ...
      <AppCard>
        ...
        <div className="mt-5">
          <button onClick={downloadFullBackup} disabled={downloadingFull} className="inline-flex min-h-11 items-center gap-2 rounded-2xl bg-primary px-5 text-sm font-extrabold text-white transition hover:bg-primary/90 disabled:opacity-60">
