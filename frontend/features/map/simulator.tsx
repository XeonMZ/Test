    ...
    <div className="space-y-5">
      ...
      <div className="flex flex-wrap items-center gap-2">
        {state.status === 'idle' || state.status === 'finished' ? (
          <button onClick={controls.start} className="inline-flex min-h-11 items-center gap-2 rounded-md bg-emerald-600 px-5 text-sm font-extrabold text-white transition hover:bg-emerald-700"><Play size={15} /> Start Simulation</button>
        ) : null}
