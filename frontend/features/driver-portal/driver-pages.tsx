...
const btnPrimary = 'inline-flex min-h-11 items-center justify-center gap-2 rounded-md bg-primary px-5 text-sm font-extrabold text-white shadow-sm shadow-primary/20 transition hover:bg-primary/90 disabled:cursor-not-allowed disabled:opacity-60';
const btnPrimarySm = 'inline-flex min-h-9 items-center gap-1.5 rounded-md bg-primary px-3 text-xs font-extrabold text-white transition hover:bg-primary/90 disabled:opacity-60';
const btnSuccess = 'inline-flex min-h-11 items-center justify-center gap-2 rounded-md bg-emerald-600 px-5 text-sm font-extrabold text-white transition hover:bg-emerald-700 disabled:opacity-60';
...
const btnDanger = 'inline-flex min-h-11 items-center justify-center gap-2 rounded-md bg-rose-600 px-5 text-sm font-extrabold text-white transition hover:bg-rose-700 disabled:opacity-60';
const btnOutline = 'inline-flex min-h-11 items-center justify-center gap-2 rounded-md border border-slate-200 px-5 text-sm font-extrabold text-slate-700 transition hover:border-primary hover:text-primary dark:border-slate-800 dark:text-slate-200 disabled:opacity-60';
