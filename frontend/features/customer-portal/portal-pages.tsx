  ...
  return (
    <div className="space-y-6">
      <PageHeader
        title="Detail Promo"
        actions={
          <Link href="/customer/promo" className="inline-flex min-h-11 items-center gap-2 rounded-md border border-slate-200 px-4 text-sm font-extrabold text-slate-700 transition hover:border-primary hover:text-primary dark:border-slate-800 dark:text-slate-200">
              ...
              <ul className="mt-5 space-y-2">
                {promo.vouchers!.map((voucher) => (
                  <li key={voucher.id} className="flex items-center justify-between gap-3 rounded-md border border-dashed border-primary/40 bg-primary/5 px-4 py-3">
                    ...
                    <button onClick={() => copy(voucher.code)} className="inline-flex items-center gap-1 rounded-md bg-primary px-3 py-1.5 text-xs font-extrabold text-white transition hover:bg-primary/90">
                      <Copy size={12} /> Salin
                    </button>
                  </li>
                ))}
                ...
                {tracking.driver ? (
                  <div className="rounded-2xl border border-slate-200 p-5 dark:border-slate-800">
                    ...
                    {tracking.driver.phone ? (
                      <a href={`https://wa.me/${(tracking.driver.phone).replace(/[^0-9]/g, '').replace(/^0/, '62')}`} target="_blank" rel="noopener noreferrer" className="mt-4 inline-flex items-center gap-2 rounded-md bg-emerald-600 px-4 py-2 text-sm font-extrabold text-white transition hover:bg-emerald-700">
                ...
                {tracking.location ? (
                  <div className="rounded-2xl border border-slate-200 p-5 dark:border-slate-800">
                    ...
                    <a
                      ...
                      className="mt-4 inline-flex items-center gap-2 rounded-md bg-primary px-4 py-2 text-sm font-extrabold text-white transition hover:bg-primary/90"
                    >
