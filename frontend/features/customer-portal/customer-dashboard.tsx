  ...
  return (
    <div className="space-y-6 sm:space-y-8">
      ...
      <PageHeader
        ...
        actions={
          <>
            <Link href="/booking" className="inline-flex min-h-11 items-center gap-2 rounded-md bg-primary px-4 py-2 text-sm font-extrabold text-white shadow-sm shadow-primary/20 transition hover:bg-primary/90">
      ...
      {pendingPayment ? (
        <div className="flex flex-col gap-3 rounded-3xl border border-amber-200 bg-amber-50 p-5 sm:flex-row sm:items-center sm:justify-between dark:border-amber-900 dark:bg-amber-950/40">
          ...
          <Link href={`/payment?booking=${pendingPayment.uuid}`} className="inline-flex min-h-11 shrink-0 items-center justify-center gap-2 rounded-md bg-amber-600 px-5 text-sm font-extrabold text-white transition hover:bg-amber-700">
