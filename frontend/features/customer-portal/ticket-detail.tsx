  ...
  return (
    <div className="space-y-6">
      <PageHeader
        ...
        actions={
          <Link href="/customer/tickets" className="inline-flex min-h-11 items-center gap-2 rounded-md border border-slate-200 px-4 text-sm font-semibold uppercase tracking-button text-slate-700 transition hover:border-primary hover:text-primary dark:border-slate-800 dark:text-slate-200">
      ...
      {ticketQuery.isLoading ? (
        ...
        <div className="grid gap-6 lg:grid-cols-[380px_1fr]">
          <AppCard className="text-center">
            <p className="text-xs font-extrabold uppercase tracking-button text-primary">Boarding pass</p>
            <div className="mx-auto mt-5 grid w-fit place-items-center rounded-2xl border border-slate-200 bg-white p-5 dark:border-slate-700">
              {qrQuery.isLoading ? (
