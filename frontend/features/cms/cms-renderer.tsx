        ...
        <section className="px-4 py-16">
          <div className="mx-auto grid max-w-7xl items-center gap-8 rounded-[2rem] bg-white p-8 shadow-soft dark:bg-slate-900 md:grid-cols-2">
            <div>
              ...
              {m(block, 'cta_label') ? <a href={m(block, 'cta_link', '#')} className="mt-6 inline-flex items-center gap-2 rounded-md bg-primary px-6 py-3 text-sm font-extrabold text-white">{m(block, 'cta_label')} <ArrowRight size={18} /></a> : null}
            </div>
            {img ? (
              // eslint-disable-next-line @next/next/no-img-element
