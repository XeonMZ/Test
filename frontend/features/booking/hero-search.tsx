  ...
  return (
    <div className="glass-panel rounded-[2rem] p-6 shadow-soft">
      <div className="rounded-[1.5rem] bg-slate-950 p-6 text-white">
        <p className="font-display text-2xl font-medium">Pesan perjalanan berikutnya</p>
      ...
      <form className="mt-6 grid gap-4" aria-label="Pencarian jadwal" onSubmit={submit}>
        ...
        <button type="submit" className="inline-flex min-h-12 w-full items-center justify-center gap-2 rounded-md bg-primary px-6 text-sm font-extrabold text-white shadow-sm shadow-primary/20 transition hover:bg-primary/90">
