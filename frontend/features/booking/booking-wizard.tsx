        ...
        <div className="space-y-6">
          <AppCard>
            ...
            >
              ...
              <button type="submit" className="mt-auto inline-flex min-h-11 items-center justify-center gap-2 rounded-md bg-primary px-5 text-sm font-extrabold text-white shadow-sm shadow-primary/20 transition hover:bg-primary/90">
                <Search size={16} /> Cari
              </button>
            </form>
          </AppCard>
          ...
          {!searchSubmitted ? (
            ...
            <AppCard>
              ...
              <button onClick={() => schedulesQuery.refetch()} className="mt-4 inline-flex items-center gap-2 rounded-md bg-primary px-4 py-2 text-sm font-extrabold text-white"><RefreshCw size={14} /> Coba lagi</button>
            </AppCard>
          ...
          <AppCard>
            ...
            <div className="mt-4 rounded-md border border-slate-200 p-5 dark:border-slate-800">
              ...
              <div className="mt-3 flex gap-2">
                ...
                <button type="button" onClick={applyPromo} className="min-h-11 rounded-md bg-primary px-5 text-sm font-extrabold text-white transition hover:bg-primary/90">Pakai</button>
              </div>
...
const inputClass =
  'min-h-11 w-full rounded-md border border-slate-200 bg-white px-4 text-sm font-semibold text-slate-900 shadow-sm outline-none transition focus:border-primary focus:ring-2 focus:ring-primary/20 dark:border-slate-800 dark:bg-slate-950 dark:text-slate-100';

const fieldInput =
  'min-h-11 w-full rounded-md border border-slate-200 bg-white px-4 text-sm font-semibold text-slate-900 shadow-sm outline-none transition focus:border-primary focus:ring-2 focus:ring-primary/20 dark:border-slate-800 dark:bg-slate-950 dark:text-slate-100';
const primaryButton =
  'inline-flex min-h-11 flex-1 items-center justify-center gap-2 rounded-md bg-primary px-5 text-sm font-extrabold text-white shadow-sm shadow-primary/20 transition hover:bg-primary/90 disabled:cursor-not-allowed disabled:opacity-60';

function BackButton({ onClick, disabled }: { onClick: () => void; disabled?: boolean }) {
  return (
    <button type="button" onClick={onClick} disabled={disabled} className="inline-flex min-h-11 items-center justify-center gap-2 rounded-md border border-slate-200 px-4 text-sm font-extrabold text-slate-700 transition hover:border-primary hover:text-primary disabled:opacity-50 dark:border-slate-800 dark:text-slate-200">
