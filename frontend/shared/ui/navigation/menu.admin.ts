import { PackageCheck, MailOpen, BarChart3, Bell, BookOpen, Bus, CalendarClock, CalendarPlus, CreditCard, LayoutDashboard, MapPinned, Package, Settings, Tag, Ticket, Users, Armchair, UserRound } from 'lucide-react';
...
export const adminMenu: MenuItem[] = [
  ...
  { label: 'Denah Armada', href: '/admin/manage/vehicle-layout', icon: Armchair },
  ...
  { label: 'Promo & Voucher', href: '/admin/promos', icon: Tag },
  { label: 'Booking Paket', href: '/admin/package-bookings', icon: PackageCheck },
  { label: 'Pusat CMS', href: '/admin/cms', icon: Package },
  { label: 'Template Email', href: '/admin/email-templates', icon: MailOpen },
