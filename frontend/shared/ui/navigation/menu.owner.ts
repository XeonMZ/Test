import { Archive, BarChart3, Bell, BookOpen, Bus, CalendarPlus, CreditCard, Flag, HeartPulse, LayoutDashboard, ListChecks, MapPinned, Package, Receipt, Settings, Tag, TrendingUp, Armchair, UserCog, UserPlus, UserRound } from 'lucide-react';
...
export const ownerMenu: MenuItem[] = [
  ...
  { label: 'Tour Package CMS', href: '/owner/cms', icon: Package },
