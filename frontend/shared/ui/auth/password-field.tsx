...
const baseInput =
  'h-11 w-full rounded-md border border-steel bg-canvas px-4 pr-12 text-sm text-ink outline-none transition-colors placeholder:text-graphite focus:border-primary dark:border-ink-soft dark:bg-ink dark:text-slate-100 dark:focus:border-primary-bright';
  ...
  return (
    <div className="relative">
      ...
      <button
        ...
        className="absolute inset-y-0 right-0 grid w-11 place-items-center rounded-r-md text-graphite transition hover:text-primary"
