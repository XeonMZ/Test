...
namespace aeroDEV\bedwars\session\settings;
...
class GameSettings {
    ...
    private bool $use_chest_shop_ui = true;
    ...
    public function usesChestShopUI(): bool {
        return $this->use_chest_shop_ui;
    }
    ...
    public function setUseChestShopUI(bool $value): void {
        $this->use_chest_shop_ui = $value;
    }
    ...
    public function setArmor(?string $armor): void {
        ...
        $inventory->setLeggings(VanillaItems::AIR());
        $inventory->setBoots(VanillaItems::AIR());
        $this->applyArmor();
    }
    ...
    private function hasSwordInInventory(): bool {
        foreach($this->session->getPlayer()->getInventory()->getContents() as $item) {
