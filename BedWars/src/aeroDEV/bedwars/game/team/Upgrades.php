...
namespace aeroDEV\bedwars\game\team;


use pocketmine\utils\Utils;
use aeroDEV\bedwars\game\team\upgrade\presets\ArmorProtection;
use aeroDEV\bedwars\game\team\upgrade\presets\HealPool;
use aeroDEV\bedwars\game\team\upgrade\presets\IronForge;
use aeroDEV\bedwars\game\team\upgrade\presets\ManiacMiner;
use aeroDEV\bedwars\game\team\upgrade\presets\SharpenedSwords;
use aeroDEV\bedwars\game\team\upgrade\presets\TowerOfHope;
use aeroDEV\bedwars\game\team\upgrade\presets\BridgeOfLife;
use aeroDEV\bedwars\game\team\upgrade\trap\Trap;
...
class Upgrades {
    ...
    private TowerOfHope $tower_of_hope;
    private BridgeOfLife $bridge_of_life;
    ...
    public function __construct() {
        ...
        $this->tower_of_hope = new TowerOfHope();
        $this->bridge_of_life = new BridgeOfLife();
    }
    ...
    public function getAll(): array {
        return [$this->armor_protection, $this->maniac_miner, $this->iron_forge, $this->sharpened_swords, $this->heal_pool, $this->tower_of_hope, $this->bridge_of_life];
    }
    ...
    public function getTowerOfHope(): TowerOfHope {
        return $this->tower_of_hope;
    }

    public function getBridgeOfLife(): BridgeOfLife {
        return $this->bridge_of_life;
    }
