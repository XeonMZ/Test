...
namespace aeroDEV\bedwars\item;


use pocketmine\utils\CloningRegistryTrait;
use aeroDEV\bedwars\game\generator\GeneratorType;
use aeroDEV\bedwars\game\shop\Shop;
use aeroDEV\bedwars\item\game\LeaveGameItem;
use aeroDEV\bedwars\item\game\TrackerShopItem;
use aeroDEV\bedwars\item\game\VoteMapItem;
use aeroDEV\bedwars\item\game\SettingsItem;
use aeroDEV\bedwars\item\setup\AddGeneratorItem;
use aeroDEV\bedwars\item\setup\AddVillagerItem;
use aeroDEV\bedwars\item\setup\CancelItem;
use aeroDEV\bedwars\item\setup\ClaimingWandItem;
use aeroDEV\bedwars\item\setup\ConfigurationItem;
use aeroDEV\bedwars\item\setup\CreateMapItem;
use aeroDEV\bedwars\item\setup\ExitSetupItem;
use aeroDEV\bedwars\item\setup\SetBedPositionItem;
use aeroDEV\bedwars\item\setup\SetTeamGeneratorItem;
use aeroDEV\bedwars\item\spectator\PlayAgainItem;
use aeroDEV\bedwars\item\spectator\ReturnToLobbyItem;
use aeroDEV\bedwars\item\spectator\SpectatorSettingsItem;
use aeroDEV\bedwars\item\spectator\TeleporterItem;
 ...
 * @method static VoteMapItem VOTE_MAP()
 * @method static SettingsItem SETTINGS()
...
class BedwarsItems {
    ...
    protected static function setup(): void {
        ...
        self::register("vote_map", new VoteMapItem());
        self::register("settings", new SettingsItem());
