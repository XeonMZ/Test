    ...
    public function register(): void
    {
        ...
        $this->app->bind(\App\Modules\Payments\Domain\Repositories\PaymentGateway::class, function (): \App\Modules\Payments\Domain\Repositories\PaymentGateway {
            ...
            if (app()->environment('production')) {
                \Illuminate\Support\Facades\Log::warning('Payment gateway is running in beta (offline) mode in production; webhooks will be rejected. Configure PAYMENT_GATEWAY=midtrans and MIDTRANS_SERVER_KEY.');
            }
