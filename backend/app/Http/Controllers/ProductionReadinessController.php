...
final class ProductionReadinessController extends Controller
{
    ...
    /** Full backup ZIP: database + uploaded files + configuration + restore guide. */
    public function downloadFullBackup(Request $request): \Symfony\Component\HttpFoundation\BinaryFileResponse
    {
        $path = $this->readiness->fullBackupZip($request->user());
