...
final readonly class DriverLocationUpdated implements ShouldBroadcast
{
    ...
    public function broadcastOn(): array { return [new PrivateChannel('trip.' . $this->tripId), new PrivateChannel('driver.' . $this->driverId), new PrivateChannel('admin'), new PrivateChannel('owner')]; }
