...
final class PaymentSuccessMail extends Mailable
{
    ...
    public function build(): self
    {
        ...
        $tpl = EmailTemplate::resolve('payment_success', [
            ...
            'intro' => 'Pembayaran Anda telah kami terima dan booking Anda terkonfirmasi. Berikut ringkasannya:',
        ], ['name' => $inv['passenger_name'], 'code' => $inv['booking_code']]);

        return $this
            ->subject($tpl['subject'])
            ->view('emails.payment-success')
            ->text('emails.payment-success-text')
            ->with(['inv' => $inv, 'tpl' => $tpl]);
    }
}
