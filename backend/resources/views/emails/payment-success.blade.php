...
<h1 style="margin:0 0 8px;font-size:22px;font-weight:800;color:#0f172a;text-align:center;">Terima kasih, {{ $inv['passenger_name'] }}!</h1>
<p style="margin:0 0 20px;font-size:14px;color:#475569;line-height:1.7;text-align:center;">
  Pembayaran Anda telah kami terima dan booking Anda <strong>terkonfirmasi</strong>. Berikut ringkasannya:
</p>
