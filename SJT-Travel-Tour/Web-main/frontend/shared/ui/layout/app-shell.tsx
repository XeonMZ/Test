...
const PUBLIC_PATHS = ['/', '/login', '/register', '/forgot-password', '/install', '/forbidden', '/unauthorized', '/jadwal'];
...
export function AppShell({ children, forcedRole }: { children: ReactNode; forcedRole?: AppRole }) {
  ...
  return (
    <div className="min-h-screen bg-secondary text-slate-950 dark:bg-slate-950 dark:text-slate-100">
      ...
      <footer className="border-t border-slate-200 px-4 py-8 text-center text-sm text-slate-500 dark:border-slate-800">© 2026 SJT Travel &amp; Tour · Sekawan Jaya Trans</footer>
